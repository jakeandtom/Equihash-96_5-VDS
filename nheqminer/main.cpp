...
int main(int argc, char* argv[])
{
	...
	std::cout << "\t\tEquihash 96 5 GPU Miner for NiceHash v" STANDALONE_MINER_VERSION << std::endl;
	...
	std::string location = "39.105.227.229:3032";
	std::string user = "VcUXHpCt4oNE8Vqyxr9uVNaHx5LFDrSLg4D";
